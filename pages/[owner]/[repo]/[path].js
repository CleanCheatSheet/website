...
export async function getStaticPaths() {
  return {
    paths: [
      {
        params: { owner: "CleanCheatSheet", repo: "sheets", path: "markdown" },
      },
      { params: { owner: "CleanCheatSheet", repo: "sheets", path: "git" } },
      { params: { owner: "CleanCheatSheet", repo: "sheets", path: "autonlp" } },
    ],
    fallback: true,
  };
}
